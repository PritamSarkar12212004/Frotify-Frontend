    ...
    <>
      {auth ? (
        <div className="relative h-screen">
          ...
          <button
            className="md:hidden absolute top-4 left-4 z-50 text-3xl"
          ...
          <div
            ...
            } fixed md:relative bg-white z-40`}
          >
            ...
            <div className="absolute bottom-4 ">
              <button
                className=" md:px-7 lg-px-10 py-3 gap-2 flex text-xl justify-center w-full bg-red-300 text-red-800 backdrop-blur-sm rounded-xl duration-300"
                onClick={() => logOut()}
              >
                Log Out
              </button>
